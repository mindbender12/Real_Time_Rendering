...
ShaderProgram::ShaderProgram(const char *vp_file, const char *fp_file)
{
	_id = glCreateProgram();
...
ShaderProgram::~ShaderProgram()
{
	vector<Shader *>::const_iterator cii;
...
void ShaderProgram::Uniform4v(const char* name, GLfloat *array)
{
	GLint loc, oldprog;
