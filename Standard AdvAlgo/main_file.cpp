...
void display() 
{
	...
	m11 = glGetUniformLocation(programObject, "prevVPMat");
	...
	view = lookAt(vec3(-20,150,300),COI,vec3(0.0,1.0, 0.0)); 
	...
	glUniformMatrix4fv(m11, 1, GL_FALSE, &prevVPMat[0][0]);
	glUniform4fv(m5,1,&diffuseTerm[0]); 
	glUniform1f(m6,kamb);
	...
	//Compute Previous View Proj Matrix for Motion Blur
	prevVPMat=projection*view;
...
int main(int argc, char** argv) 
{
	...
	glutCreateWindow("GLSL Texture, Cube Environment Map, Shadow Map, Reflection and Refraction"); 
